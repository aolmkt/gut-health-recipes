      ...
      <div className="page-transition">
        ...
        <section className="relative h-[60vh] md:h-[70vh] flex items-end">
          <div className="absolute inset-0">
            <img src={heroBread} alt="Pan artesanal" className="w-full h-full object-cover" />
        ...
        <section className="bg-cream py-16 md:py-24">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="grid gap-4">
              {ebookSections.map((section, index) => <motion.div key={section.id} initial={{
              opacity: 0,
              x: -20
            }} whileInView={{
              opacity: 1,
              ...
              delay: index * 0.1
                  ...
                  <Link to={`/seccion/${section.id}`} className="group flex items-center justify-between p-5 md:p-6 rounded-lg bg-background hover:shadow-soft transition-all border border-transparent hover:border-border">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        {section.recipes && <p className="text-sm text-muted-foreground mt-1">
        ...
        <section className="max-w-3xl mx-auto px-5 md:px-6 py-16 md:py-24 text-center">
          ...
          once: true
            ...
            <Link to="/seccion/introduccion" className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-colors min-h-[52px] text-lg">
              Comenzar a leer
        ...
        <footer className="border-t border-border py-8 px-6">
          <p className="text-center text-sm text-muted-foreground">© 2026 Pan Sin Hinchazón — Manual Completo</p>
        </footer>
      </div>
    </Layout>;
};
