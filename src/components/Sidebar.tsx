              ...
              {section.recipes && section.recipes.length > 0 ? (
                <div>
                  <button
                    ...
                    className={cn(
                      "w-full flex items-center justify-between py-2.5 px-3 rounded-md text-left text-sm font-medium transition-colors",
                ...
                <Link
                  ...
                  onClick={() => setIsOpen(false)}
                  className={cn(
                    "flex items-center gap-2 py-2.5 px-3 rounded-md text-sm font-medium transition-colors",
                    isActiveSection(section.id)
                      ? "bg-primary text-primary-foreground"
                      : "text-sidebar-foreground hover:bg-sidebar-accent"
                  )}
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 lg:hidden p-2 rounded-md bg-background shadow-soft border border-border"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.aside
            ...
            className="fixed top-0 left-0 w-80 h-full bg-sidebar z-40 shadow-xl lg:hidden overflow-hidden"
          >
            {sidebarContent}
          </motion.aside>
        )}
